        ...
        <div className="w-full max-w-md">
          <Card className="bg-white dark:bg-[#2f3136] border-gray-200 dark:border-[#202225] shadow-lg transition-colors">
            <CardHeader className="text-center pb-6">
              ...
              <p className="text-gray-600 dark:text-[#72767d] mt-2">Sign in to your AtlasHook account</p>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              <Button
                ...
                onClick={() => (window.location.href = route("discord.redirect"))}
                disabled={processing}
              >
              ...
              <form className="space-y-5" onSubmit={submit}>
                ...
                <div className="flex items-center space-x-3">
                  <Checkbox
                    ...
                    tabIndex={3}
                    className="border-gray-300 dark:border-[#4f545c] data-[state=checked]:bg-[#FFD700] data-[state=checked]:border-[#FFD700]"
                  />
                  <Label htmlFor="remember" className="text-gray-900 dark:text-white text-sm">
